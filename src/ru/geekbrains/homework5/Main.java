...
public class Main {
    public static void main(String[] args) {
        ...
        personArray[2] = new Employee("Комиссаров Лаврентий Якунович", "Аудитор", "komisarov@email.com", 880057, 50000, 40);
        personArray[3] = new Employee("Кудряшов Гарри Германович", "Аукционист", "kydrashov@email.com", 880068, 60000, 50);
